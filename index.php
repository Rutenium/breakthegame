...
?>
<div class="post">
	<h1 class="intro">Welcome to Break The Game,<?php if(isset($_SESSION['iduser'])){echo $_SESSION['iduser'].',';}?> This is a place currently in construction where you can submit record for every video game! for now, we are still working on the website, you can try and submit a record if you'd like!</h1>
	<div class="breakit">
